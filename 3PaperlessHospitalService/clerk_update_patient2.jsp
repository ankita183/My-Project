...
PreparedStatement pst=con.prepareStatement("update patient_table set patient_id=?,patient_name=?,age=?,gender=?,weight=?,city=?,blood_group=?,percent=?,join_date=?,insurance_id=?,contact_no=?,email_id=?,problem=?,stage=? where patient_id=?");
pst.setInt(1,pid);
...
pst.setInt(15,pid);
pst.executeUpdate();
out.println("<center><h2>Patient Updated successfully......</h2></center>");
